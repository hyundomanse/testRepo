...
<html>
  ...
  <body onload="enableEditMode()">
    ...
    <div class="write-btns">
      ...
      <button class="c-btn" onclick="history.back()" type="button">Cancel</button>
    </div>
   ...
   <button data-oper='list' class="btn btn-primary"onclick="location.href='/board/list'">목록</button>
   <button class="s-btn" type="submit">Save</button>
    ...
    <script type="text/javascript">
      function enableEditMode() {
        ...
        $('iframe').contents().props('designMode','on')
      }
      function Edit(command) {
       // richTextField.document.execCommand(command, false, null)
        console.log(command)
        $('iframe').css('font', command)
      ...
      $('.s-btn').on("click", function(){	
    	...
    	formObj.attr('action', '/board/neweditor').attr('method', 'post');
    	formObj.submit();
      })
