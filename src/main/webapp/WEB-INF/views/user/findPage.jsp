    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="http://localhost:8080/board/index"><img src="/resources/img/logo.svg" style="width: 150px" /></a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" style="margin: 0 auto; align-items: flex-end">
              <li class="nav-item">
                <a href="http://localhost:8080/board/aboutUs" class="nav-link">About Us</a>
              </li>
              <li class="nav-item">
            ...
            <ul class="navbar-nav" style="align-items: flex-end">
              <li class="nav-item">
                <a href="http://localhost:8080/board/login.html" href="login.html" class="nav-link">LogIn</a>
              </li>
              <li class="nav-item">
      ...
      <div class="content-background">
        ...
        <div id="modal2" class="modal-overlay2">
            <div class="modal-window2">
                <div class="close-area2">
                  <p>확인</p>
                </div>
                <div class="content2">
                    <p>가입한 메일 주소로 임시 비밀번호를 보냈습니다</p>
          ...
          <div class="login-form-container shadow">
            ...
            <div class="login-form-right-side">
              ...
              <div class="login-input-container">
                <div class="send-email">가입한 메일주소로 비밀번호를 보내드립니다</div>
                ...
                <div class="login-sign">
                  <div class="login-btn-signin">
                    <button class="login-btn" id="btn-modal2">메일전송</button>
                  </div>
                  <div class="login-btn-signup">
                    <button onclick="location.href='http://localhost:8080/board/signUp'" class="login-btn">Sign up</button>
                    <a href="http://localhost:8080/board/signUp">아직회원이아니신가요?</a>
                </div>
              </div>
            </div>
          </div>
